...
(defn drunken-comment []
  (rand-nth ["*hic*" "BURP!" "Wheresh me kej?" "SCOOOORE!" "*hic*" "*hic*"]))

(defn make-comments []
  (while true (println (drunken-comment)) (Thread/sleep (int (* 30000 (rand))))))
...
(defn ^{:help-arglists '([]) :no-project-needed true} rum
...
USAGE: lein rum -m NAMESPACE[/MAIN_FUNCTION] [ARGS...]
